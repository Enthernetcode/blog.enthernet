...
from content.observability_security import OBSERVABILITY_SECURITY_DAYS
from content.day100 import DAY_100

SOURCES = (AWS_DAYS, ANSIBLE_DAYS, LINUX_NETWORKING_DAYS, DOCKER_DAYS, KUBERNETES_DAYS, CICD_DAYS, OBSERVABILITY_SECURITY_DAYS, DAY_100)
